...
#### run this scirpt with `CUDA_VISIBLE_DEVICES=0,1,2 bash scripts/train_local_CelebA.sh`
...
LOAD_PRETRAIN="checkpoint_local_CelebA/epoch_1_iter_9000_Gloss_9.578453_Dloss_0.021031"
